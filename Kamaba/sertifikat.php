              ...
              <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li class="has-children active">
                  ...
                  <ul class="dropdown arrow-top">
                    ...
                    <li class="active"><a href="sertifikat.php">Sertifikat</a></li>
          ...
          <div class="col-lg-8">
            ...
            ?>
              <script type="text/javascript">
                alert("Anda belum mengikuti kegiatan yang bersertifikat!");
            ...
            <div class="d-block d-md-flex listing-horizontal">
              ...
              <div class="lh-content">
                <a href="funcSertifikat.php?kd_kegiatan=<?= $row["kd_kegiatan"];?>&&kd_anggota=<?= $row["kd_anggota"];?>" class="bookmark"><span class="icon-print"></span></a>
