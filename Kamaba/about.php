      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-5 ml-auto">
            ...
            <p>Keluarga Mahasiswa Blora (KAMABA) Yogyakarta merupakan organisasi mahasiswa di Yogyakarta yang berasal dari daerah Kabupaten Blora, Provinsi Jawa Tegah. </p>
            <p class="mb-4">KAMABA sendiri telah didirkan sejak tahun 90-an dengan maksud sebagai wadah dalam mempererat kekeluargaan antar mahasiswa yang berasal dari tempat yang sama yaitu Kabupaten Blora. Selain kegiatan keorganisasian ada juga kegiatan-kegiatan yang meliputi berbagai bidang seperti : </p>
			...
			<p> Sesuai namanya, diharapkan KAMABA dapat menyatukan ikatan keluarga antar mahasiswa Blora dimanapun itu. </p>
          </div>
        </div>
      </div>
    </div>
